                  ...
                  <div class="card__body">
                     ...
                     <div class="flex">
                        ...
                        <div class="w-1/3">
                           <CustomInfo
                              label="tempat lahir"
                              :value="calonSiswaData.tempat_lahir"
                           />
                        </div>
                        <div class="w-1/3">
                           <CustomInfo
                              label="tanggal lahir"
                              :value="getTanggalLahir"
                           />
                        </div>
                     </div>
                     <div class="flex">
                        <div class="w-1/3">
                           <CustomInfo
                              label="nama ayah"
                              :value="calonSiswaData.nama_ayah"
                           />
                        </div>
                        ...
                        <div class="w-1/3">
                           <CustomInfo
                              label="nama ibu"
                              :value="calonSiswaData.nama_ibu"
                           />
                        </div>
                        <div class="w-1/3">
                           <CustomInfo
                              label="nomor telepon"
                              :value="calonSiswaData.no_telepon"
                           />
                        </div>
                     </div>
                     <div>
