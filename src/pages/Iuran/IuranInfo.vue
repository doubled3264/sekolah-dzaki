          ...
          <div class="card iuran-info__left">
            ...
            <div class="card__body">
              <div class="iuran-info__list">
                <CustomInfo label="nama" :value="iuranData.nama" vertical />
                <CustomInfo label="interval" :value="iuranData.interval" vertical />
                <CustomInfo label="keterangan interval" :value="
