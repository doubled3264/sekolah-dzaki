      ...
      <CustomModal>
        ...
        <template v-slot:body>
          <div class="row mb-2">
            <div class="input-field w-full">
              <CustomInput type="text" label="nama iuran *" placeholder="masukan nama iuran"
                :error-state="errorState.nama" v-model:input-value="iuran.nama"
          ...
          <div class="row gap-4 mb-2">
            <div class="input-field w-1/2">
              <CustomInput type="text" label="keterangan" placeholder="masukan keterangan"
                :error-state="errorState.keterangan" v-model:input-value="iuran.keterangan" />
            </div>
            <div class="input-field w-1/2">
              <CustomInput type="number" label="nominal *" placeholder="masukan nominal"
                :error-state="errorState.nominal" v-model:input-value="iuran.nominal"
          ...
          <div v-if="iuran.interval == '2'" class="row gap-8 mb-2">
            <div class="input-field w-6/12">
              <VueMultiselect v-model="iuran.interval_detail" :options="state.multiSelect.options"
