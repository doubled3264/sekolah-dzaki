                  ...
                  <div class="row gap-4 mb-2">
                     ...
                     <div class="input-field w-1/2">
                        <CustomInput
                           ...
                           :error-state="errorState.exist.nominal"
                           v-model:input-value="iuran.exist.nominal"
                  ...
                  <div class="row mb-2">
                     <div class="input-field w-full">
                        <CustomInput
                           ...
                           :error-state="errorState.baru.nama"
                           v-model:input-value="iuran.baru.nama"
                  ...
                  <div class="row gap-4 mb-2">
                     <div class="input-field w-1/2">
                        <CustomInput
                           ...
                           :error-state="errorState.baru.keterangan"
                           v-model:input-value="iuran.baru.keterangan"
                        />
                     </div>
                     <div class="input-field w-1/2">
                        <CustomInput
                           ...
                           label="nominal *"
                           placeholder="masukan nominal"
                           :error-state="errorState.baru.nominal"
                           v-model:input-value="iuran.baru.nominal"
                           @validate-input="validateInput('nominal')"
                        />
                     </div>
                  </div>
