...
function editBanner(bannerIndex) {
   ...
   imageToEdit.value.preview = `${APIURL}/files/banner/${banner.value[bannerIndex].placement}/${banner.value[bannerIndex].banner}`
                        ...
                        >
                           <div class="image-content">
                              <img
                                 ...
                                 :src="`${APIURL}/files/banner/${item.placement}/${item.banner}`"
                                 alt=""
                              />
                           </div>
                           <div
