...
import { calendar } from '../../utils/svg-vars'
...
<template>
   ...
   >
      ...
      >
         <template
            v-slot="{ inputValue, inputEvents, showPopover, hidePopover }"
         >
            <div
               :class="[
            ...
            >
               ...
               <input
                  :value="inputValue"
                  @focusin="inputFocus($event, showPopover)"
                  @focusout="inputFocus($event, hidePopover)"
                  @keyup.enter="inputFocus($event, hidePopover)"
                  v-on="inputEvents"
               />
            </div>
         </template>
