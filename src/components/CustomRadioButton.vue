  ...
  <div class="custom-radio-button">
    ...
    <div class="custom-radio-button__wrapper">
      <div class="custom-radio-button__item">
        <input :id="randomNumber.labelItem1" type="radio" :name="randomNumber.group" value="1" @change="inputEvent"
          checked />
        <label :for="randomNumber.labelItem1">{{ getRadioLabel(0) }}</label>
      </div>
      <div class="custom-radio-button__item">
        <input :id="randomNumber.labelItem2" type="radio" :name="randomNumber.group" @change="inputEvent" value="0" />
